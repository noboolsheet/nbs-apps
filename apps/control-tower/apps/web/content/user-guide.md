...
| **Tareas importadas** | Projects › Tasks | **Twenty** (las de origen Twenty) | task de Twenty → pull (marcadas como origen Twenty) | En Twenty. Conviven con las tareas nativas de CT sin mezclarse. (Las tareas no tienen write-back.) |
